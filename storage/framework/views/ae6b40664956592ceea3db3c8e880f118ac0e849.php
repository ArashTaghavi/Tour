<?php $__env->startSection('content'); ?>
            ...
            <div class="tabs_wrapper tabs1_wrapper">
                <div class="tabs tabs1">
                    ...
                    <div class="tabs_content tabs1_content">
                        ...
                        <div id="tabs-5">
                            <form action="<?php echo e(route('site.tours.search')); ?>" method="get" class="form1">
                                <div class="row">
                                    <div class="col-sm-4 col-md-2">
                                        <div class="select1_wrapper">
                                            <label>Where?</label>
                                            <div class="input2_inner">
                                                <input type="text" name="w" class="input"
                                                       value="">
                                            </div>
                                        </div>
                                    </div>
    ...
    <div id="why1">
        <div class="container">
            ...
            <div class="title1 animated" data-animation="fadeInUp" data-animation-delay="200">Lorem ipsum dolor sit
                amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod <br>tincidunt ut laoreet dolore magna
                ...
                <div class="col-sm-3">
                    <div class="thumb2 animated" data-animation="flipInY" data-animation-delay="200">
                        <div class="thumbnail clearfix">
                            <a href="#">
                                <figure class="">
                                    <img src="/site-assets/images/why1.png" alt="" class="img1 img-responsive">
                                    <img src="/site-assets/images/why1_hover.png" alt="" class="img2 img-responsive">
                                </figure>
                                <div class="caption">
                ...
                <div class="col-sm-3">
                    <div class="thumb2 animated" data-animation="flipInY" data-animation-delay="300">
                        <div class="thumbnail clearfix">
                            <a href="#">
                                <figure class="">
                                    <img src="/site-assets/images/why2.png" alt="" class="img1 img-responsive">
                                    <img src="/site-assets/images/why2_hover.png" alt="" class="img2 img-responsive">
                                </figure>
                                <div class="caption">
                ...
                <div class="col-sm-3">
                    <div class="thumb2 animated" data-animation="flipInY" data-animation-delay="400">
                        <div class="thumbnail clearfix">
                            <a href="#">
                                <figure class="">
                                    <img src="/site-assets/images/why3.png" alt="" class="img1 img-responsive">
                                    <img src="/site-assets/images/why3_hover.png" alt="" class="img2 img-responsive">
                                </figure>
                                <div class="caption">
                ...
                <div class="col-sm-3">
                    <div class="thumb2 animated" data-animation="flipInY" data-animation-delay="500">
                        <div class="thumbnail clearfix">
                            <a href="#">
                                <figure class="">
                                    <img src="/site-assets/images/why4.png" alt="" class="img1 img-responsive">
                                    <img src="/site-assets/images/why4_hover.png" alt="" class="img2 img-responsive">
                                </figure>
                                <div class="caption">
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="popular">
                                                        <div class="popular_inner">
                                                            <figure>
                                                                <img src="/site-assets/images/popular01.jpg" alt=""
                                                            ...
                                                            <div class="caption">
                                                                ...
                                                                <div class="txt3 clearfix">
                                                                    <div class="left_side">
                                                                        <div class="stars1">
                                                                            <img src="/site-assets/images/star1.png"
                                                                                 alt="">
                                                                            <img src="/site-assets/images/star1.png"
                                                                                 alt="">
                                                                            <img src="/site-assets/images/star1.png"
                                                                            ...
                                                                            <img src="/site-assets/images/star1.png"
                                                                                 alt="">
                                                                            <img src="/site-assets/images/star2.png"
                                                                                 alt="">
                                                                        </div>
                                                ...
                                                <li>
                                                    <div class="popular">
                                                        <div class="popular_inner">
                                                            <figure>
                                                                <img src="/site-assets/images/popular02.jpg" alt=""
                                                                     class="img-responsive">
                                                                <div class="over">
                                                ...
                                                <li>
                                                    <div class="popular">
                                                        <div class="popular_inner">
                                                            <figure>
                                                                <img src="/site-assets/images/popular03.jpg" alt=""
                                                                     class="img-responsive">
                                                                <div class="over">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-md-push-6">
                    <div class="content">
                        ...
                        <div class="txt2 animated" data-animation="fadeIn" data-animation-delay="150">Lorem ipsum dolor
                            sit amet, consectetuer adipiscing elit, set amet.
                        </div>
                        <div class="txt3 animated" data-animation="fadeIn" data-animation-delay="200">
                            <p>
                                ...
                                sod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim
                                veniam, quis nostrud exerci tation ullamcorper suscipit dolore magna aliquam erat
                                voutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit..
                            </p>
                            <p>
                ...
                <div class="col-sm-12 col-md-6 col-md-pull-6 animated" data-animation="fadeInLeft"
                    ...
                    <img src="/site-assets/images/people.png" alt="" class="img1 img-responsive">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-sm-4 col-md-2 col-xs-6">
                    <div class="thumb1 animated" data-animation="flipInX" data-animation-delay="100">
                        <div class="thumbnail clearfix">
                            <a href="#">
                                <figure>
                                    <img src="/site-assets/images/partner1.jpg" alt="" class="img1 img-responsive">
                                    <img src="/site-assets/images/partner1_hover.jpg" alt=""
                ...
                <div class="col-sm-4 col-md-2 col-xs-6">
                    <div class="thumb1 animated" data-animation="flipInX" data-animation-delay="200">
                        <div class="thumbnail clearfix">
                            <a href="#">
                                <figure>
                                    <img src="/site-assets/images/partner2.jpg" alt="" class="img1 img-responsive">
                                    <img src="/site-assets/images/partner2_hover.jpg" alt=""
                                         class="img2 img-responsive">
                                </figure>
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-2 col-xs-6">
                    <div class="thumb1 animated" data-animation="flipInX" data-animation-delay="300">
                        <div class="thumbnail clearfix">
                            <a href="#">
                                <figure>
                                    <img src="/site-assets/images/partner3.jpg" alt="" class="img1 img-responsive">
                                    <img src="/site-assets/images/partner3_hover.jpg" alt=""
                                         class="img2 img-responsive">
                                </figure>
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-2 col-xs-6">
                    <div class="thumb1 animated" data-animation="flipInX" data-animation-delay="400">
                        <div class="thumbnail clearfix">
                            <a href="#">
                                <figure>
                                    <img src="/site-assets/images/partner4.jpg" alt="" class="img1 img-responsive">
                                    <img src="/site-assets/images/partner4_hover.jpg" alt=""
                                         class="img2 img-responsive">
                                </figure>
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-2 col-xs-6">
                    <div class="thumb1 animated" data-animation="flipInX" data-animation-delay="500">
                        <div class="thumbnail clearfix">
                            <a href="#">
                                <figure>
                                    <img src="/site-assets/images/partner5.jpg" alt="" class="img1 img-responsive">
                                    <img src="/site-assets/images/partner5_hover.jpg" alt=""
                                         class="img2 img-responsive">
                                </figure>
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-2 col-xs-6">
                    <div class="thumb1 animated" data-animation="flipInX" data-animation-delay="600">
                        <div class="thumbnail clearfix">
                            <a href="#">
                                <figure>
                                    <img src="/site-assets/images/partner6.jpg" alt="" class="img1 img-responsive">
                                    <img src="/site-assets/images/partner6_hover.jpg" alt=""
                                         class="img2 img-responsive">
                                </figure>
                            </a>
                        </div>
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hotel\resources\views/site/index.blade.php ENDPATH**/ ?>