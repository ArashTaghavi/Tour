                ...
                <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                    ...
                    <div class="dropdown-list-content dropdown-list-message">
                        <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar
											text-white"> <img alt="image" src="/dashboard-assets/assets/img/users/user-1.png"
                ...
                <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                    ...
                    <div class="dropdown-list-content dropdown-list-icons">
                        <a href="#" class="dropdown-item dropdown-item-unread"> <span class="dropdown-item-icon bg-primary text-white"> <i class="fas
												...
												fa-user"></i>
                  </span> <span class="dropdown-item-desc"> <b>شما</b> و <b>نیلوفر</b> اکنون <span class="time">10 ساعت</span> با هم دوست هستید<span class="time"></span>
                  </span>
                    </a> <a href="#" class="dropdown-item"> <span class="dropdown-item-icon bg-success text-white"> <i class="fas
												fa-check"></i>
                  </span> <span class="dropdown-item-desc"> <b>محمد</b> وظیفه <b>باگ هدر را</b> به <b>موفقیت </b> <span class="time">12 ساعت قبل منتقل کرده است</span>
                  </span>
                    </a> <a href="#" class="dropdown-item"> <span class="dropdown-item-icon bg-danger text-white"> <i class="fas fa-exclamation-triangle"></i>
                  </span> <span class="dropdown-item-desc">کمبود میزان حافظه. بیایید آن را تمیز کنیم! <span class="time">17 ساعت قبل</span>
                  </span>
