            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input v-model="form.title"
                           ...
                           placeholder="نام هاستل را وارد کنید">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleSubmit() {
                axios.put(`/hostels/${this.$route.params.id}`, this.form).then(response => {
                    this.successNotify(response);
                    this.$router.push('/hostels/ours')
                }).catch(error => this.errorNotify(error));
            },
            getHotel() {
                axios.get(`/hostels/${this.$route.params.id}`)
